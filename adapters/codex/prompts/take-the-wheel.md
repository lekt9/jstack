Hand the wheel to Jesus — start a 7-step Genesis-days loop with KJV citation at every step.
...
promise (default "<promise>SHIPPED</promise>") at Step 7 with PROMOTE.
